...
(defun create-spacemacs-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (bg1           (if (eq variant 'dark) (if (true-color-p) "#222222" "#262626") (if (true-color-p) "#fbf8ef" "#ffffff")))
        ...
        (cblk-bg       (if (eq variant 'dark) (if (true-color-p) "#222222" "#262626") (if (true-color-p) "#e8e3f0" "#ffffff")))
        ...
        (cblk-ln-bg    (if (eq variant 'dark) (if (true-color-p) "#333333" "#333333") (if (true-color-p) "#ddd8eb" "#dfdfff")))
        ...
        (comment-bg    (if (eq variant 'dark) (if (true-color-p) "#222222" "#262626") (if (true-color-p) "#ecf3ec" "#ffffff")))
        ;;(comment-bg    (if (eq variant 'dark) (if (true-color-p) "#292b2e" "#262626") (if (true-color-p) "#ecf3ec" "#ffffff")))
